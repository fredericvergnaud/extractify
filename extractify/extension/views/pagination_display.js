function displayPagination(level) {
    ...
    colorWrapper.innerHTML = '<span class="cell_title">color</span><br/><div class="pagination-color highlight_pagination">&nbsp;</div>';
    ...
    classNameWrapper.innerHTML = '<span class="cell_title">tag & class</span><br/>' + level.pagination.tagClass;
    ...
    removePaginationButtonWrapper.setAttribute('class', "rows_table_cell rows_table_cell_button");
    ...
    removePaginationButton.innerHTML = "Remove";
