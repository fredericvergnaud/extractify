function displayLevel(level) {
    ...
    addRowButton.addEventListener("click", function (event) {
        ...
        let rowTagClassInput = document.getElementById("row_tag_class");
        rowTagClassInput.value = "";
    ...
    addPaginationButton.addEventListener("click", function (event) {
        ...
        // on efface l'input de tag & class
        let paginationTagClassInput = document.getElementById("pagination_tag_class");
        paginationTagClassInput.value = "";
        ...
        selectPagination()
            .then(function (paginationTagClass) {
                console.log("paginationTagClass choosen = " + paginationTagClass);
                if (paginationTagClass !== "") {
                    // add pagination                    
                    highlightPagination(level.tabId, level, paginationTagClass)
                        .then(function (selectedPagination) {
                            let pagination = addPagination(selectedPagination.paginationTagClass, selectedPagination.paginationPrefix, selectedPagination.paginationStep, level);
